...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="tags_input" placeholder="Ej. Node.js, PHP, CSS, Laravel, UX/UI, JavaScript">
        <div id="tags" class="formulario__listado"></div>
        <input type="hidden" name="tags" id="tags" value="<?php echo $ponente->tags ?? ''; ?>">
    </div>
</fieldset>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="text" class="formulario__input--sociales" name="redes[github]" placeholder="GitGub" value="<?php echo $redes->github ?? ''; ?>">
        </div>
    </div>
